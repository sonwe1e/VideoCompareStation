...
| 图片 100%、三图、Flicker/Fade | `ImageWorkspace.qml`、`ImageReviewController.h/.cpp`、`ImageFolderPairModel.cpp` | `MainQmlContractTests.cpp`、`ImageReviewControllerTests.cpp`；台账 `I-04`、`C-01`、`C-02` |
