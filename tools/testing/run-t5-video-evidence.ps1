...
function Invoke-T5Run {
    ...
    $entry = [pscustomobject]@{
        ...
        held_step_p50_ms           = Get-MetricField $metrics 'held_step_p50_ms'
        held_step_p95_ms           = Get-MetricField $metrics 'held_step_p95_ms'
        held_step_p99_ms           = Get-MetricField $metrics 'held_step_p99_ms'
        held_step_submitted_frames = Get-MetricField $metrics 'held_step_submitted_frames'
        held_step_presented_frames = Get-MetricField $metrics 'held_step_presented_frames'
        held_step_sequence_errors  = Get-MetricField $metrics 'held_step_sequence_errors'
